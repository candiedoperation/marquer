...
public class Marquer.Widgets.LeftSelectDrive : Gtk.Grid {
    private Gtk.Label panel_left_title;
    private Gtk.Label panel_left_subtitle;
    private Gtk.Image panel_left_image;
    
    public LeftSelectDrive () {
        Object ();        
    }
    
    construct {
        panel_left_title = new Gtk.Label("Select Flash Drive");
        panel_left_title.get_style_context ().add_class (Granite.STYLE_CLASS_H1_LABEL);
        
        panel_left_subtitle = new Gtk.Label("Select an Installation Medium to Flash");
